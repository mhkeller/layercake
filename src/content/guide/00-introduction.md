...
<g>
	{#each c.data as d}
		<circle cx={c.xScale(c.x(d))} cy={c.yScale(c.y(d))} {fill} {r} />
	{/each}
</g>
```
...
<g>
	{#each c.data as d}
		<circle cx={c.xGet(d)} cy={c.yGet(d)} {fill} {r} />
	{/each}
</g>
```
