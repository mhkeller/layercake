<!--
	@component
	Generates an HTML x-axis along the top of the chart, for server-side rendered charts. If the x scale is a band scale, each tick sits in the middle of its band.
