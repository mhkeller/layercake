/**
	...
	@type {Array} list An array of values or objects.
	@type {String|Function} [accessor] An optional accessor function that takes an object and returns the value to judge uniqueness by. If accessor is a string instead of a function, judges uniqueness by the property named by accessor on each of the objects.
	@type {Boolean} [transform=true] If true, return the transformed value from accessor.
	@returns {Array}
*/
/* --------------------------------------------
 *
