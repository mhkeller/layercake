...
export default [
	{
		replPath: 'ac23120460b1409a9e1e6fd328b63b64?version=3.46.2',
		title: 'Line + area',
		slug: 'Line',
		component: Line
	},
	{
		replPath: '1969b7c74b124445ad9d55ad28542cd6?version=3.46.2',
		title: 'WebGL Scatter (svg axes, quadtree hover)',
		slug: 'ScatterWebgl',
		component: ScatterWebGL
	},
	{
		replPath: 'af25643f1e3c4a6f93aed138ac8b1550?version=3.46.2',
	...
	{
		replPath: '9d7b933184db447c83cc315ad278dabd?version=3.46.2',
		title: 'Stacked column',
		slug: 'ColumnStacked',
		component: ColumnStacked
	},
	{
		replPath: '3e18cab5e88a4b29a14a08fdccd418c2?version=3.46.2',
		title: 'Bar',
		slug: 'Bar',
		component: Bar
	},
	{
		replPath: 'af5ce39a12d74ed7a484010a49f09eaa?version=3.46.2',
		title: 'Stacked bar',
		slug: 'BarStacked',
		component: BarStacked
	},
	{
		replPath: 'ea09c9f533594b3ab9ebb509c9bfc03a?version=3.46.2',
		title: 'Multiline (html labels + quadtree tooltip)',
		slug: 'MultiLine',
		component: MultiLine
	},
	{
		replPath: '1eb71294f7c147ce906aa2dfc6e2f64e?version=3.46.2',
		title: 'Stacked area',
		slug: 'AreaStacked',
		component: AreaStacked
	},
	{
		replPath: '9862620a31cd4f9dac8191df953e4532?version=3.46.2',
		title: 'Scatter (html)',
		slug: 'Scatter',
		component: Scatter
	},
	{
		replPath: 'f3f78a8b122b40dda9ac1e32dee0737f?version=3.46.2',
		title: 'Cleveland dot plot',
		slug: 'ClevelandDotPlot',
		component: ClevelandDotPlot
	},
	{
		replPath: 'c1e6634def024499ad026ecab3c39499?version=3.46.2',
		title: 'Calendar (one cake per month)',
		slug: 'Calendar',
		component: Calendar
	},
	{
		replPath: '3142518ab68f493cad0e327dba5cae1a?version=3.46.2',
		title: 'Time of day plot',
		slug: 'Timeplot',
		component: Timeplot
	},
	{
		replPath: '74c8fd12be824840bb78bcaa2eea33bb?version=3.46.2',
		title: 'Histogram (variable bins)',
		slug: 'Histogram',
		component: Histogram
	},
	{
		replPath: '82b6e8a37e9f4eaa8140498c1b1f490d?version=3.46.2',
		title: 'Small multiples (animated domain transition)',
		slug: 'SmallMultiples',
		component: SmallMultiples
	},
	{
		replPath: '7b692f97938f4bc2a79d62d5ccdbb02d?version=3.46.2',
		title: 'Brush',
		slug: 'Brush',
		component: Brush
	},
